    ...
    extends CasCollectionReader_ImplBase
{
        ...
        throws ResourceInitializationException
    {
        ...
        try {
            ...
            resources = new ArrayList<>(scan(getSourceLocation(), includes, excludes));
            Collections.sort(resources,new Comparator<Resource>(){

				@Override
				public int compare(Resource o1, Resource o2) {
					return Long.compare(new File(o1.getLocation().replace("file:", "")).length(), new File(o2.getLocation().replace("file:", "")).length());
				}
